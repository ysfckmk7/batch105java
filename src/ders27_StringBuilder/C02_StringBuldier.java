...
public class C02_StringBuldier {
    public static void main(String[] args) {
        ...
        sb.trimToSize();
        // atama yapmadıgımız halde bu degısıklık kalıcı olur mu ?
        // StringBuilder mutable oldugundan method'larla yapılan degısıklıkler kalıcı olur
        ...
        // StringBuldier'i String'e cevirirseniz veya String dondurecek method'lar kullanırsanız
        // String'in immutable ozellıgı devreye gırer ve yapılan degısıkler kalıcı olmaz

        //sb= sb.toString().toUpperCase();
        // nonprimite data turlerınde farklı data turunden atama yapamazsınız
        ...
        sb.delete(5,sb.length());// Baslangıc ındexi dahil, Bitiş indexi dahil degil
