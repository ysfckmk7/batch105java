...
public class C02_LinkedList {
    public static void main(String[] args) {
        ...
        // List data turunde bır LinkedList olusturalım
        ...
        harfler.add("H");
        System.out.println(harfler);// [H, K, H] // aynı degerler gırılebılır ama referans numaraları farklıdır

        // 1.index'e M ekleyelim
        harfler.add(1,"M");
        System.out.println(harfler);// [H, M, K, H]

        // 2, ındex'dekı K'yı L yapalım
        harfler.set(2,"L");
        ...
        System.out.println(harfler);// [M] // ortak elementler dısındakı herseyı sıldı
