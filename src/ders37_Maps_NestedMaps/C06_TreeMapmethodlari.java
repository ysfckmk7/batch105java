...
public class C06_TreeMapmethodlari {
    public static void main(String[] args) {
        ...
        System.out.println(harfSayilariMap.descendingMap());// {K=5, D=3, C=15, A=10} // tersten yazdırır
        ...
        System.out.println(harfSayilariMap.headMap("D",true));// {A=10, C=15, D=3} // D'yi dahil etmek icin inclusive'i kullandik

        System.out.println(harfSayilariMap.tailMap("C"));// {C=15, D=3, K=5} // baslangıc dahıl,bıtıs dahıl olmadıgı icin C'yi dahil etti
        System.out.println(harfSayilariMap.tailMap("C",false));// {D=3, K=5} // C'yi dahil etmek istemedigimiz icin inclusive'i kullandik

        System.out.println(harfSayilariMap.pollFirstEntry());// A=10 // ilk degeri donderip siliyor
        System.out.println(harfSayilariMap);// {C=15, D=3, K=5}

        System.out.println(harfSayilariMap.pollLastEntry());// K=5 // son degeri donderip siliyor
